    ...
    $.fn.sudyfocus = function(opts) {
        ...
        this.each(function() {
            ...
            function u() {
                ...
                s = q;
				/* g.stop(true,true).animate({opacity:"1"},1000);
				g.stop(true,true).animate({left: "0%"},1000,function(){
					g.stop(true,true).animate({left: "0%"},3500,function(){
						g.stop(true,true).animate({opacity:"0"},400,function(){
							g.stop(true,true).animate({left: "-100%"},100);
						});
					});
				}); */
				
/* 				h.stop(true,true).animate({opacity:"1"},1000);
				h.stop(true,true).animate({left: "0%"},1000,function(){
					h.stop(true,true).animate({left: "0%"},3500,function(){
						h.stop(true,true).animate({opacity:"0"},400,function(){
							h.stop(true,true).animate({left: "-100%"},100);
						});
					});
				}); */
            }
...
/* 			$(".focus-pagination1").find(".focus-time").each(function(){
			...
			$(".fouce-box-m,.focus-pagination1,.focus-bg,.focus-text-box").wrapAll('<div class="rb"></div>');////////////////////////////////////////////
