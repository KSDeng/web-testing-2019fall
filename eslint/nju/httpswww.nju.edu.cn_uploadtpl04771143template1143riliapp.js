...
this.J(".top-nav-window").find("li").on("mouseenter",function(){
		_this.J(this).children('.sub-menu').show();
	}).on("mouseleave",function(){
		_this.J(this).children('.sub-menu').hide();
	});
	this.J(".top-nav-window1").find("li").on("mouseenter",function(){
		_this.J(this).children('.sub-menu').show();
	}).on("mouseleave",function(){
		_this.J(this).children('.sub-menu').hide();
	});
	this.J(".langwindow22").find("li").on("mouseenter",function(){
		_this.J(this).children('.sub-menu').show();
	}).on("mouseleave",function(){
		_this.J(this).children('.sub-menu').hide();
	});
	this.J(".langwindow901").find("li").on("mouseenter",function(){
		_this.J(this).children('.sub-menu').show();
	}).on("mouseleave",function(){
		_this.J(this).children('.sub-menu').hide();
	});
